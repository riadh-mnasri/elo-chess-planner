...
export default async function TournamentPrintPage({
  ...
  return (
    <main className="mx-auto flex w-full max-w-2xl flex-col gap-8 px-6 py-12 print:px-0 print:py-4">
      <h1 className="font-display text-2xl font-semibold">{tournament.name}</h1>

      {tournament.rounds.map((round) => (
        <section key={round.number} className="flex flex-col gap-2 break-inside-avoid">
